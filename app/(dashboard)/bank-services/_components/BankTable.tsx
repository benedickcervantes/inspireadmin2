      ...
      >
        <div className="overflow-x-auto">
          <Table
            ...
            headerHeight={40}
            hover
            className="app-table !bg-transparent min-w-[950px] cursor-pointer [&_.rs-table-row:hover_.rs-table-cell]:!bg-[var(--surface-hover)] [&_.rs-table-row:hover_.rs-table-cell]:!transition-colors [&_.rs-table-row:hover_.rs-table-cell]:!duration-200"
